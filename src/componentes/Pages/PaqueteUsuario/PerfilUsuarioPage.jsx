...
function PerfilUsuarioPage() {
    ...
    const [correo] = useState('vinivini@email.com');
    const [telefono] = useState('78945612');
    const [fechaNacimiento] = useState('1990-05-15');
    const [sexo] = useState('Masculino');
    const [estado] = useState('Activo');
    const [Puntos] = useState('10');
            ...
            <div className='perfilCard'>
                ...
                <div className="headerUsuario">
                    <div className="tituloConIcono">
                        <h2 className='titleUsuario'>{nombreUsuario}</h2>
                ...
                <div className="mb-3">
                    <label>Nombre:</label>
                    <input type="text" className="form-control" value={nombreUsuario} readOnly />
                </div>

                <div className="mb-3">
                    <label>Correo:</label>
                    <input type="email" className="form-control" value={correo} readOnly />
                </div>

                <div className="mb-3">
                    <label>Teléfono:</label>
                    <input type="tel" className="form-control" value={telefono} readOnly />
                </div>
                ...
                <div className="mb-3">
                    <label>Sexo:</label>
                    <input type="text" className="form-control" value={sexo} readOnly />
                </div>
                ...
                <div className="mb-3">
                    <label>Puntos:</label>
                    <input type="number" className="form-control" value={Puntos} readOnly />
                </div>
